...
namespace Turbo.Plugins.Prrovoss.Popups
{
    ...
    public class ActorAppearedPopup : BasePlugin, IInGameWorldPainter
    {
        ...
        public void PaintWorld(WorldLayer layer)
        {
            ...
            {
                var candidates = Hud.Game.Actors.Where(a => (uint)a.SnoActor.Sno == actor.Sno && !(actor.FloorCoords.Any(c => EqualCoordinates(c, a.FloorCoordinate))) && !(actor.CreatedTicks.Contains(a.CreatedAtInGameTick)) );
