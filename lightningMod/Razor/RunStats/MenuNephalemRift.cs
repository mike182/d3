...
namespace Turbo.Plugins.Razor.RunStats
{
	...
	public class MenuNephalemRift : BasePlugin, IMenuAddon, IAfterCollectHandler/*, INewAreaHandler, IInGameTopPainter, ILeftClickHandler, IRightClickHandler*/
	{
		...
		//public IFont TimeFont1 { get; set; }
		...
		public void OnRegister(MenuPlugin plugin)
		{
			...
			//TimeFont1 = Hud.Render.CreateFont("tahoma", plugin.FontSize, 255, 255, 255, 255, false, false, true);
			...
			Label = new LabelRowDecorator(Hud,
				...
				new LabelTextureDecorator(Hud, Hud.Texture.GetTexture("Marker_Portal_Gold")) {TextureHeight = 34, ContentHeight = plugin.MenuHeight, ContentWidth = 18}//,
