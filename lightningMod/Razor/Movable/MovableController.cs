namespace Turbo.Plugins.Razor.Movable
{
    ...
    public class MovableController : BasePlugin, IInGameTopPainter, IHotkeyEventHandler, IAfterCollectHandler, ILeftClickHandler, IRightClickHandler, ITextLogger, ILeftBlockHandler, IPluginManifest //, ICustomizer, IInGameWorldPainter
    {
		//IPluginManifest
		public string Name { get; set; } = "Movable Plugin System";
        public string Description { get; set; } = "Movable Plugin System is a framework for managing plugin displays that can be moved around on the screen and resized with your mouse.";
		public string Version { get; set; }
		public List<string> Dependencies { get; set; } = new List<string>() {
			"Turbo.Plugins.Razor.Click.ClickEventHandler",
			"Turbo.Plugins.Razor.Hotkey.HotkeyEventHandler",
			"Turbo.Plugins.Razor.Log.TextLogger",
			"Turbo.Plugins.Razor.Util.UIOverlapHelper",
		};
		...
		public string ConfigFilePath { get; set; } = "User"; //@"plugins\User\"; //tier 3
		...
		public void Log(string path)
		{
			...
			foreach (string configName in ConfigChanged)
			{
				...
				string filePath = (string.IsNullOrEmpty(configName) ? ConfigFileName : configName) + ".cs";
